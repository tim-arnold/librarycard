...
if (require.main === module) {
  ...
  switch (command) {
    case 'create':
      ...
      backup.createProductionBackup(reason)
        .then(result => {
    ...
    case 'verify':
      ...
      if (!backupId) {
        console.error('Usage: node auto-backup.js verify <backup-id>');
        process.exit(1);
      }
    ...
    default:
      console.log('Usage:');
      console.log('  node auto-backup.js create [reason]  - Create a new backup');
      console.log('  node auto-backup.js list             - List all backups');
      console.log('  node auto-backup.js verify <id>      - Verify a backup');
      process.exit(1);
  }
}
