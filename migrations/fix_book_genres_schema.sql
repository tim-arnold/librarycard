-- Fix existing book_genres table to add missing columns for genre management
-- This handles the case where book_genres table exists but lacks new columns

-- Check if book_genres exists and drop it if it has old schema
-- Then recreate with proper schema
DROP TABLE IF EXISTS book_genres;

-- Recreate book_genres table with complete schema
